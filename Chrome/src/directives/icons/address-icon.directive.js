wwapp.directive('addressIcon', function () {
    return {
        restrict: 'EA',
        template: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="552.912px" height="552.912px" viewBox="0 0 552.912 552.912" style="enable-background:new 0 0 552.912 552.912;" xml:space="preserve">
        <g>
            <g>
