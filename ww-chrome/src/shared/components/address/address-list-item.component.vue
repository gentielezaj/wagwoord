<template>
  <div class="list-item">
    ...
    <div class="domain title">
      <span class="data-value">{{item.firstName}} {{item.lastName}}</span>
    </div>
...
<script>
import {listItemComponent} from "../common/core-component";
...
export default listItemComponent(component, 'address', form);
</script>
